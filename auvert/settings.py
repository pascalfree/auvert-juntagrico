"""
Django settings for auvert project.
"""
...
ALLOWED_HOSTS = ['my.auvert.ch','auvert.juntagrico.science', 'localhost',]
...
WSGI_APPLICATION = 'auvert.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('JUNTAGRICO_DATABASE_NAME','auvert.db'), 
...
ORGANISATION_NAME = "Genossenschaft auVert"
ORGANISATION_LONG_NAME = "Genossenschaft auVert"
ORGANISATION_ADDRESS = {"name":"Genossenschaft auVert", 
            "street" : "Speichergasse",
            "number" : "30",
            "zip" : "3150",
            "city" : "Schwarzenburg",
            "extra" : ""}
ORGANISATION_BANK_CONNECTION = {"PC" : "-",
            "IBAN" : "CH670851 8045 0143 1814 6",
            "BIC" : "-",
